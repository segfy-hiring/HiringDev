...
namespace Joao.HiringDev.Dominio.Entidades
{
    ...
    {        
        ...
        public CanalYoutube(string id, string title, string description, string channelId, string channelTitle, string publishedAtRaw, string liveBroadcastContent, string eTag, string thumbnailUrlVideoImage)
        {
            Id = id;
            Title = title;
